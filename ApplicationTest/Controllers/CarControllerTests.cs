...
namespace ApplicationTest.Controllers
{
    public class CarControllerTests
    {
        ...
        readonly ClientRequestResponse _sampleValidClient = new()
        ...
        readonly CarRequestResponse _sampleValidCar = new()
        ...
        public async Task RegisterCarForClientAsync__should_return_ok_for_valid_input()
        {
            ...
            Mock.Get(mockCarService).Setup(service => service.RegisterCarForClientAsync(It.IsAny<string>(), It.IsAny<Domain.DTOs.CarDto>()))
        ...
        public async Task GetCarsForSale__should_return_ok_for_valid_input()
        {
            ...
            Mock.Get(mockCarService).Setup(service => service.GetCarsForSale(It.IsAny<DateTime>(), It.IsAny<DateTime>()))
                .Returns(It.IsAny<IEnumerable<Domain.DTOs.CarDto>>);
